...
BLOCK_MAPPINGS_1710_TO_1182: Dict[str, BlockMapping] = {
    ...
    "appliedenergistics2:tile.BlockCraftingStorage": BlockMapping(
        ...
        id_1182="ae2:crafting_unit_1k",  # Rozpoznanie przez metadata
        has_tile_entity=True,
    ...
    "appliedenergistics2:tile.BlockQuartzFixture": BlockMapping(
        id_1710="appliedenergistics2:tile.BlockQuartzFixture",
    ...
    "appliedenergistics2:tile.BlockCableBus": BlockMapping(
        ...
        id_1182="ae2:cable_bus",
        has_tile_entity=True,
        nbt_converter="cable_bus",
        notes="Cable Bus - kable i części"
    ),
}
...
def resolve_crafting_storage_variant(base_id: str, metadata: int) -> str:
    ...
    return variants.get(metadata, "ae2:crafting_unit_1k")
...
def resolve_crafting_unit_variant(metadata: int) -> Tuple[str, str]:
    ...
    return variants.get(metadata, ("ae2:crafting_unit", "crafting_unit"))


# Zestaw wszystkich ID bloków AE2 1.7.10
ALL_AE2_BLOCK_IDS_1710 = set(BLOCK_MAPPINGS_1710_TO_1182.keys())
