"""
Test integracyjny: konwersja TD TE z mapy testowej thermal_test (większa).
"""
import sys
...
def test_thermal_test():
    world_path = ROOT / "lightweigh_map_templates" / "1710_modded" / "thermal_test"
    ...
    print(f"\nWynik testu integracyjnego (thermal_test):")
