#!/usr/bin/env python3
"""Convert the applied Mekanism Task 5A 1.7.10 test world into a 1.18.2 patch.
...
DEFAULT_WORLD = PROJECT_ROOT / "lightweigh_map_templates/1710_modded/mekanism_task5a_world_v2"
DEFAULT_SOURCE_PATCH = SCENARIO_DIR / "mekanism_task5a_source_patch_1710.json"
DEFAULT_EXPECTED_PATCH = SCENARIO_DIR / "mekanism_task5a_converted_patch_1182.json"
DEFAULT_OUTPUT_PATCH = SCENARIO_DIR / "mekanism_task5a_realworld_converted_patch_1182.json"
DEFAULT_REPORT = SCENARIO_DIR / "mekanism_task5a_realworld_conversion_report.json"
...
def convert_world(world: Path, source_patch_path: Path, expected_patch_path: Path | None) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    target_patch = {
        ...
        "metadata": {
            "name": "mekanism_task5a_realworld_converted",
            "generated_by": "convert_applied_test_world.py",
    ...
    report = {
        "name": "Mekanism Task 5A real-world conversion report",
