#!/usr/bin/env python3
"""Verify that the Mekanism Task 5A source patch was written to a 1.7.10 world."""
...
DEFAULT_PATCH = Path(__file__).resolve().parent / "mekanism_task5a_source_patch_1710.json"
...
def main() -> int:
    ...
    parser.add_argument("--report", type=Path, default=Path(__file__).resolve().parent / "mekanism_task5a_world_verify_report.json")
